...
<body>
                ...
                <div class="col-12">
                    <div class="advanced-search-form">
                        ...
                        <div class="search-title">
                            <a href="postproperty.php"><font size = "5" color="white">Login</font></a>
                        </div>
                        
                        <div class="header"><form method="post" action="postproperty.php">
    ...
    <p>
        Not yet a member? <a href="postpropertyregister.php">Sign up</a>
    </p>
  </form>
</div>
                    </div>
